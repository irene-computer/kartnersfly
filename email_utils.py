        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Notre equipe vous contactera prochainement pour finaliser les details de votre voyage.</p>
                    
                    <div style="text-align: center;">
                        <a href="http://localhost:5000/contact" class="btn">Nous contacter</a>
                    </div>
                    
                    <p style="margin-top: 20px; font-size: 12px; color: #6c757d;">
                        Si vous avez des questions, n'hesitez pas a nous contacter au +237 676 268 350 ou par email a kta2k23@gmail.com
                    </p>
                </div>
                <div class="footer">
                    <p>&copy; 2026 Kartners Travel Agency - Voyagez, comme vous l'imaginez</p>
...
def send_admin_notification_email(booking_data):
    ...
    try:
        ...
        msg = Message(
            ...
            recipients=['admin@kartners.com'],  # A modifier
            html=render_template_string(admin_template, **booking_data)
        )
        
        mail.send(msg)
        print(f"[INFO] Email admin envoye")
        return True
    except Exception as e:
